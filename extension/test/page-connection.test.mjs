...
test("수신자가 사라진 일반 웹 탭은 콘텐츠 스크립트를 다시 넣고 요청을 재시도한다", async () => {
  ...
  assert.deepEqual(fake.injections, [
    { target: { tabId: 17, frameIds: [0] }, files: ["site-adapters.js", "messenger-adapters.js", "content-helpers.js", "dom-policy.js", "translation-audit.js", "text-segments.js", "popup-locales.js", "content.js"] },
