...
test("일반 본문은 최상위 문서에만, 삽입 영상 제목은 허용된 embed 문서에만 주입한다", () => {
  for (const manifestName of ["manifest.json", "manifest.firefox.json"]) {
    ...
    assert.deepEqual(manifest.content_scripts[0].js, ["site-adapters.js", "messenger-adapters.js", "content-helpers.js", "dom-policy.js", "translation-audit.js", "text-segments.js", "popup-locales.js", "content.js"]);
