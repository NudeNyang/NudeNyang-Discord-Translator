...
export const COPY = Object.freeze({
  ...
  "빠른 전환키": ["Quick toggle shortcut", "クイック切り替えキー", "快速切换快捷键"],
  ...
  "입력란을 선택한 뒤 원하는 단축키를 누르십시오. Delete를 누르면 사용하지 않습니다.": ["Select the field and press the desired shortcut. Press Delete to disable it.", "入力欄を選択して希望のショートカットを押してください。Deleteキーで無効にできます。", "选择输入框并按下所需快捷键。按 Delete 可停用。"],
  "새 단축키를 입력하십시오. Delete를 누르면 사용하지 않고 Esc를 누르면 취소됩니다.": ["Enter a new shortcut. Press Delete to disable it or Esc to cancel.", "新しいショートカットを入力してください。Deleteキーで無効、Escキーでキャンセルできます。", "请输入新的快捷键。按 Delete 停用，或按 Esc 取消。"],
  "빠른 전환키를 사용하지 않습니다.": ["The quick toggle shortcut is disabled.", "クイック切り替えキーは使用しません。", "快速切换快捷键已停用。"],
  "브라우저 단축키 설정을 열지 못했습니다": ["Could not open browser shortcut settings", "ブラウザーのショートカット設定を開けませんでした", "无法打开浏览器快捷键设置"],
  "빠른 전환키를 적용하지 못했습니다": ["Could not apply the quick toggle shortcut", "クイック切り替えキーを適用できませんでした", "无法应用快速切换快捷键"],
  "브라우저 연결": ["Browser connections", "ブラウザー接続", "浏览器连接"],
  "확장 프로그램의 연결 상태를 확인하고 브라우저 등록 단축키를 변경합니다.": ["Check extension connections and change browser-registered shortcuts.", "拡張機能の接続状態を確認し、ブラウザーに登録されたショートカットを変更します。", "检查扩展程序连接状态并更改浏览器注册的快捷键。"],
  "브라우저 단축키 변경": ["Change browser shortcut", "ブラウザーのショートカットを変更", "更改浏览器快捷键"],
