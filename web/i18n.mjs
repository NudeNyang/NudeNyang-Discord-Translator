...
export const COPY = Object.freeze({
  ...
  "닉네임 번역하지 않기": ["Do not translate nicknames", "ニックネームを翻訳しない", "不翻译昵称"],
  "메시지 작성자의 닉네임을 원문 그대로 표시합니다.": ["Display message authors' nicknames unchanged.", "メッセージ投稿者のニックネームを原文のまま表示します。", "消息发送者的昵称将保持原样显示。"],
