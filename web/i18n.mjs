...
export const COPY = Object.freeze({
  ...
  "웹 메신저 읽기 번역": ["Web messenger reading translation","ウェブメッセンジャーの閲覧翻訳","网页聊天阅读翻译"],
  "웹 메신저 개인정보 동의": ["Web messenger privacy consent","ウェブメッセンジャーのプライバシー同意","网页聊天隐私同意"],
  "웹 메신저 읽기 번역에 대한 개인정보 동의가 필요합니다.": ["Privacy consent is required for web messenger reading translation.","ウェブメッセンジャーの閲覧翻訳には、プライバシーに関する同意が必要です。","网页聊天阅读翻译需要您的隐私同意。"],
  "메인 앱에서 웹 메신저 읽기 번역을 켜십시오.": ["Enable web messenger reading translation in the main app.","メインアプリでウェブメッセンジャーの閲覧翻訳を有効にしてください。","请在主应用中启用网页聊天阅读翻译。"],
  "웹 메신저 읽기 번역은 로컬 AI에서만 사용할 수 있습니다.": ["Web messenger reading translation is available only with local AI.","ウェブメッセンジャーの閲覧翻訳はローカルAIでのみ使用できます。","网页聊天阅读翻译仅可使用本地 AI。"],
  "현재 열린 대화가 없습니다.": ["No conversation is currently open.","現在開いている会話はありません。","当前未打开对话。"],
  "번역할 메시지를 기다리고 있습니다.": ["Waiting for messages to translate.","翻訳するメッセージを待機しています。","正在等待可翻译的消息。"],
  "개인정보 안내 확인": ["Review privacy notice","プライバシー案内を確認","查看隐私说明"],
  "웹 메신저 읽기 번역 개인정보 안내": ["Privacy notice for web messenger reading translation","ウェブメッセンジャーの閲覧翻訳に関するプライバシー案内","网页聊天阅读翻译隐私说明"],
  "웹 메신저 읽기 번역은 기본적으로 꺼져 있습니다. 동의한 브라우저에서만 사용할 수 있습니다.": ["Web messenger reading translation is off by default. It is available only in browsers where you have given consent.","ウェブメッセンジャーの閲覧翻訳は初期設定では無効です。同意したブラウザーでのみ使用できます。","网页聊天阅读翻译默认关闭，仅可在您已同意的浏览器中使用。"],
  "현재 열린 대화의 메시지 본문·링크 미리보기 텍스트와 현재 Discord 서버의 보이는 채널 이름만 별도로 설치한 NudeNyang Windows 앱에서 로컬 AI로 번역합니다.": ["Only message bodies and link-preview text in the open conversation, plus visible channel names in the current Discord server, are translated with local AI by the separately installed NudeNyang Windows app.","現在開いている会話のメッセージ本文・リンクプレビューのテキストと、現在のDiscordサーバーで表示されているチャンネル名のみを、別途インストールしたNudeNyang WindowsアプリのローカルAIで翻訳します。","仅通过另行安装的 NudeNyang Windows 应用中的本地 AI，翻译当前对话的消息正文、链接预览文字及当前 Discord 服务器中可见的频道名称。"],
  "확장 프로그램이 보관하는 대화 내용과 번역문은 메모리에서만 처리하며, 대화 전환 또는 종료 시 삭제합니다. 디스크 캐시, 번역 기록 또는 본문 로그에 저장하지 않습니다.": ["Conversation content and translations held by the extension are processed only in memory and deleted when you switch or close the conversation. They are not saved to disk caches, translation history, or message-body logs.","拡張機能が保持する会話内容と翻訳文はメモリ上でのみ処理し、会話の切り替え時または終了時に削除します。ディスクキャッシュ、翻訳履歴、本文ログには保存しません。","扩展保存的对话内容和译文仅在内存中处理，并在切换或关闭对话时删除，不保存至磁盘缓存、翻译历史或正文日志。"],
  "외부 번역 서비스로 대화 내용을 전송하지 않습니다.": ["Conversation content is not sent to external translation services.","外部翻訳サービスに会話内容を送信しません。","不会将对话内容发送至外部翻译服务。"],
  "입력 및 전송 기능을 사용하지 않으며, 사용자 이름과 연락처를 번역하지 않습니다.": ["No message composition or sending features are used, and user names and contacts are not translated.","入力や送信機能は使用せず、ユーザー名や連絡先は翻訳しません。","不使用输入或发送功能，也不翻译用户名称和联系人。"],
  "이 브라우저에는 동의 기록과 설정만 저장됩니다. 위 내용을 확인하고 웹 메신저 읽기 번역에 동의합니다.": ["Only consent records and settings are saved in this browser. I have read the information above and consent to web messenger reading translation.","このブラウザーには同意の記録と設定のみが保存されます。上記を確認し、ウェブメッセンジャーの閲覧翻訳に同意します。","此浏览器中仅保存同意记录和设置。我已阅读上述说明并同意使用网页聊天阅读翻译。"],
  "동의하고 사용": ["Agree and enable","同意して利用する","同意并启用"],
  "동의 철회": ["Withdraw consent","同意を撤回","撤回同意"],
  "이 브라우저에 웹 메신저 읽기 번역 동의가 저장되었습니다.": ["Your consent to web messenger reading translation has been saved in this browser.","このブラウザーにウェブメッセンジャーの閲覧翻訳への同意を保存しました。","已在此浏览器中保存您对网页聊天阅读翻译的同意。"],
  "현재 열린 대화의 메시지 본문·링크 미리보기 텍스트와 현재 Discord 서버의 보이는 채널 이름만 별도로 설치한 NudeNyang Windows 앱에서 로컬 AI로 번역합니다. 입력 및 전송 기능을 사용하지 않으며, 사용자 이름과 연락처를 번역하지 않습니다. 웹 메신저 읽기 번역에 대한 개인정보 동의가 필요합니다.": ["Only message bodies and link-preview text in the open conversation, plus visible channel names in the current Discord server, are translated with local AI by the separately installed NudeNyang Windows app. No message composition or sending features are used, and user names and contacts are not translated. Privacy consent is required for web messenger reading translation.","現在開いている会話のメッセージ本文・リンクプレビューのテキストと、現在のDiscordサーバーで表示されているチャンネル名のみを、別途インストールしたNudeNyang WindowsアプリのローカルAIで翻訳します。 入力や送信機能は使用せず、ユーザー名や連絡先は翻訳しません。 ウェブメッセンジャーの閲覧翻訳には、プライバシーに関する同意が必要です。","仅通过另行安装的 NudeNyang Windows 应用中的本地 AI，翻译当前对话的消息正文、链接预览文字及当前 Discord 服务器中可见的频道名称。 不使用输入或发送功能，也不翻译用户名称和联系人。 网页聊天阅读翻译需要您的隐私同意。"],
  "설정": ["Settings", "設定", "设置"],
  "사전": ["Dictionary", "辞書", "词典"],
  ...
  "사전 뜻이 없으면 설정된 번역 모델로 보완합니다.": ["Missing dictionary meanings are supplemented by the configured translation model.", "辞書に意味がない場合は、設定した翻訳モデルで補います。", "词典中没有释义时，将由已配置的翻译模型补充。"],
  "선택한 텍스트가 해당 서비스로 전송될 수 있습니다.": ["The selected text may be sent to that service.", "選択したテキストがそのサービスに送信されることがあります。", "所选文本可能会发送到相应服务。"],
  "주변 문맥은 PC 안에서만 처리됩니다.": ["Nearby context is processed only on this PC.", "周辺の文脈はPC内だけで処理されます。", "周边上下文仅在本机处理。"],
  "선택형 사전": ["Selection dictionary", "選択辞書", "划词词典"],
  "메시지 안에서 바로 뜻 확인": ["Look up meanings inside messages", "メッセージ内ですぐに意味を確認", "直接在消息中查询释义"],
  "Discord 메시지에서 단어나 짧은 구절을 대략 선택한 뒤 Aa 버튼을 누르면, 사전이 일치하는 표현을 나누어 뜻과 발음을 찾습니다. 개인 용어와 설치된 사전팩은 PC 안에서만 조회합니다.": ["Roughly select a word or short phrase in a Discord message and press Aa. The dictionary splits matching expressions and finds their meanings and pronunciations. Personal terms and installed packs are searched only on this PC.", "Discordのメッセージで単語や短いフレーズを大まかに選択してAaボタンを押すと、辞書が一致する表現に分けて意味と発音を検索します。個人用語とインストール済み辞書パックはPC内だけで検索します。", "在 Discord 消息中大致选择一个词或短语并按 Aa，词典会拆分匹配的词语并查找释义和发音。个人术语和已安装词典包仅在本机查询。"],
  "선택형 사전 사용": ["Use selection dictionary", "選択辞書を使用", "使用划词词典"],
  "번역 기능이 꺼져 있어도 사전을 독립적으로 사용할 수 있습니다.": ["The dictionary works independently even when translation is off.", "翻訳機能がオフでも、辞書を単独で使用できます。", "即使翻译功能关闭，也可以独立使用词典。"],
  "외부 사전 연결": ["External dictionary", "外部辞書", "外部词典"],
  "더 자세한 정보가 필요할 때 기본 브라우저로 엽니다. 선택한 단어는 해당 사이트에 전달됩니다.": ["Open the default browser for more details. The selected word is sent to that site.", "詳しい情報が必要な場合は既定のブラウザーで開きます。選択した単語はそのサイトに送信されます。", "需要更多详细信息时，将在默认浏览器中打开。所选单词会发送到该网站。"],
  "Wiktionary (기본 브라우저)": ["Wiktionary (default browser)", "Wiktionary（既定のブラウザー）", "Wiktionary（默认浏览器）"],
  "개인 사전": ["Personal dictionary", "個人辞書", "个人词典"],
  "제품명, 고유명사와 자주 쓰는 표현을 저장하고 필요한 항목을 빠르게 찾습니다.": ["Save product names, proper nouns, and frequently used expressions, then find them quickly.", "製品名、固有名詞、よく使う表現を保存し、必要な項目をすぐに検索できます。", "保存产品名、专有名词和常用表达，并快速找到所需条目。"],
  "전체 관리": ["Manage all", "すべて管理", "管理全部"],
  "빠른 추가": ["Quick add", "クイック追加", "快速添加"],
  "저장한 용어 관리": ["Manage saved terms", "保存した用語を管理", "管理已保存术语"],
  "개인 용어를 불러오고 있습니다.": ["Loading personal terms.", "個人用語を読み込んでいます。", "正在加载个人术语。"],
  "사전 설정으로 돌아가기": ["Back to dictionary settings", "辞書設定に戻る", "返回词典设置"],
  "가져오기": ["Import", "インポート", "导入"],
  "내보내기": ["Export", "エクスポート", "导出"],
  "내보내기 형식": ["Export format", "エクスポート形式", "导出格式"],
  "개인 사전 검색": ["Search personal dictionary", "個人辞書を検索", "搜索个人词典"],
  "원문, 표시어, 태그 또는 메모 검색": ["Search source, display term, tag, or note", "原文、表示語、タグ、メモを検索", "搜索原文、显示词、标签或备注"],
  "원문 언어 필터": ["Source language filter", "原文言語フィルター", "原文语言筛选"],
  "대상 언어 필터": ["Target language filter", "対象言語フィルター", "目标语言筛选"],
  ...
  "오래된 수정순": ["Oldest updated", "更新が古い順", "最早更新"],
  "원문 오름차순": ["Source term, ascending", "原文の昇順", "原文升序"],
  "표시어 오름차순": ["Display term, ascending", "表示語の昇順", "显示词升序"],
  "개 선택": [" selected", "件選択", " 项已选择"],
  "선택 없음": ["Nothing selected", "選択なし", "未选择"],
  "전체 선택": ["Select all", "すべて選択", "全选"],
  "선택 취소": ["Clear selection", "選択を解除", "取消选择"],
  "선택 항목 삭제": ["Delete selected", "選択項目を削除", "删除所选项"],
  "고정": ["Pin", "固定", "固定"],
  "고정 해제": ["Unpin", "固定を解除", "取消固定"],
  "편집": ["Edit", "編集", "编辑"],
  "원문 용어 복사": ["Copy source term", "原文の用語をコピー", "复制原文词语"],
  "이전": ["Previous", "前へ", "上一页"],
  "다음": ["Next", "次へ", "下一页"],
  "1페이지": ["Page 1", "1ページ", "第 1 页"],
  "용어 편집": ["Edit term", "用語を編集", "编辑术语"],
  "태그 (쉼표로 구분)": ["Tags (comma-separated)", "タグ（カンマ区切り）", "标签（以逗号分隔）"],
  "프로젝트, 인물, 자주 사용": ["Project, person, frequently used", "プロジェクト、人物、よく使う", "项目、人物、常用"],
  "목록 위에 고정": ["Pin to top", "一覧の先頭に固定", "固定到列表顶部"],
  "대소문자 구분": ["Match case", "大文字と小文字を区別", "区分大小写"],
  "단어 단위로 일치": ["Match whole word", "単語単位で一致", "全词匹配"],
  "저장": ["Save", "保存", "保存"],
  "용어 가져오기": ["Import terms", "用語をインポート", "导入术语"],
  "JSON 백업이나 CSV, TSV 파일을 불러오거나 표의 내용을 붙여 넣을 수 있습니다.": ["Load a JSON backup, CSV or TSV file, or paste table contents.", "JSONバックアップ、CSV、TSVファイルを読み込むか、表の内容を貼り付けられます。", "可加载 JSON 备份、CSV 或 TSV 文件，也可粘贴表格内容。"],
  "파일 선택": ["Choose file", "ファイルを選択", "选择文件"],
  "기본 원문 언어": ["Default source language", "既定の原文言語", "默认原文语言"],
  "기본 대상 언어": ["Default target language", "既定の対象言語", "默认目标语言"],
  "중복 처리": ["Duplicate handling", "重複時の処理", "重复项处理"],
  "중복 건너뛰기": ["Skip duplicates", "重複をスキップ", "跳过重复项"],
  "기존 항목 덮어쓰기": ["Overwrite existing terms", "既存の項目を上書き", "覆盖现有条目"],
  "원문,표시어,원문 언어,대상 언어,태그,메모": ["Source,display term,source language,target language,tags,note", "原文,表示語,原文言語,対象言語,タグ,メモ", "原文,显示词,原文语言,目标语言,标签,备注"],
  "가져올 내용을 선택하거나 붙여 넣으십시오.": ["Choose content to import or paste it here.", "インポートする内容を選択するか、ここに貼り付けてください。", "请选择要导入的内容或粘贴到此处。"],
  "검색 결과가 없습니다.": ["No matching terms.", "一致する用語がありません。", "没有匹配的术语。"],
  "원문 용어를 복사했습니다.": ["Copied the source term.", "原文の用語をコピーしました。", "已复制原文词语。"],
  "개인 사전을 내보냈습니다.": ["Exported the personal dictionary.", "個人辞書をエクスポートしました。", "已导出个人词典。"],
  "선택한 용어를 삭제하시겠습니까?": ["Delete the selected terms?", "選択した用語を削除しますか？", "要删除所选术语吗？"],
  "선택한 개인 용어를 삭제했습니다.": ["Deleted the selected personal terms.", "選択した個人用語を削除しました。", "已删除所选个人术语。"],
  "개인 사전을 불러오지 못했습니다": ["Could not load the personal dictionary", "個人辞書を読み込めませんでした", "无法加载个人词典"],
  "개인 사전을 검색하지 못했습니다": ["Could not search the personal dictionary", "個人辞書を検索できませんでした", "无法搜索个人词典"],
  "개인 사전을 수정하지 못했습니다": ["Could not update the personal dictionary", "個人辞書を更新できませんでした", "无法更新个人词典"],
  "개인 사전을 가져오지 못했습니다": ["Could not import the personal dictionary", "個人辞書をインポートできませんでした", "无法导入个人词典"],
  "개인 사전을 내보내지 못했습니다": ["Could not export the personal dictionary", "個人辞書をエクスポートできませんでした", "无法导出个人词典"],
  "제품명, 고유명사와 자주 쓰는 표현의 표시 방식을 직접 지정합니다.": ["Define how product names, proper nouns, and frequently used expressions are displayed.", "製品名、固有名詞、よく使う表現の表示方法を指定します。", "自定义产品名、专有名词和常用表达的显示方式。"],
  "원문 언어": ["Source language", "原文の言語", "原文语言"],
  "대상 언어": ["Target language", "対象言語", "目标语言"],
  "원문 용어": ["Source term", "原文の用語", "原文术语"],
  "표시할 용어": ["Display term", "表示する用語", "显示术语"],
  "메모 (선택)": ["Note (optional)", "メモ（任意）", "备注（可选）"],
  "용어 추가": ["Add term", "用語を追加", "添加术语"],
  ...
  "언어팩 관리": ["Manage language packs", "言語パックを管理", "管理语言包"],
  "언어팩을 확인하고 있습니다.": ["Checking language packs.", "言語パックを確認しています。", "正在检查语言包。"],
  "언어팩 검색": ["Search language packs", "言語パックを検索", "搜索语言包"],
  "설치할 언어 검색": ["Search available languages", "インストールする言語を検索", "搜索可安装的语言"],
  "설치 상태 필터": ["Installation status filter", "インストール状態フィルター", "安装状态筛选"],
  "전체 상태": ["All statuses", "すべての状態", "全部状态"],
  "설치된 언어": ["Installed languages", "インストール済みの言語", "已安装语言"],
  "미설치 언어": ["Available to install", "未インストールの言語", "未安装语言"],
  "설치된 확장 사전이 없습니다.": ["No extended dictionaries are installed.", "インストール済みの拡張辞書はありません。", "尚未安装扩展词典。"],
  "조건에 맞는 언어팩이 없습니다.": ["No language packs match these filters.", "条件に一致する言語パックはありません。", "没有符合条件的语言包。"],
  ...
  "사전팩 상태를 변경하지 못했습니다": ["Could not change the dictionary pack state", "辞書パックの状態を変更できませんでした", "无法更改词典包状态"],
  "사전 사용 설정을 변경하지 못했습니다": ["Could not change the dictionary setting", "辞書の使用設定を変更できませんでした", "无法更改词典使用设置"],
  "개인 사전에 저장하지 못했습니다": ["Could not save to the personal dictionary", "個人辞書に保存できませんでした", "无法保存到个人词典"],
  "사전 데이터 폴더를 열지 못했습니다": ["Could not open the dictionary data folder", "辞書データフォルダーを開けませんでした", "无法打开词典数据文件夹"],
  "개인 사전 용어를 삭제했습니다.": ["Deleted the personal dictionary term.", "個人辞書の用語を削除しました。", "已删除个人词典术语。"],
  "사전팩을 삭제했습니다.": ["Deleted the dictionary pack.", "辞書パックを削除しました。", "已删除词典包。"],
  "사전팩을 설치했습니다.": ["Installed the dictionary pack.", "辞書パックをインストールしました。", "已安装词典包。"],
  "개인 사전에 저장했습니다.": ["Saved to the personal dictionary.", "個人辞書に保存しました。", "已保存到个人词典。"],
  "사전 데이터 폴더를 열었습니다.": ["Opened the dictionary data folder.", "辞書データフォルダーを開きました。", "已打开词典数据文件夹。"],
  "원문 용어와 표시할 용어를 모두 입력하십시오.": ["Enter both the source term and the display term.", "原文の用語と表示する用語を両方入力してください。", "请输入原文术语和显示术语。"],
  "사전팩": ["Dictionary packs", "辞書パック", "词典包"],
  "개인 용어": ["Personal terms", "個人用語", "个人术语"],
  "항목": ["entries", "項目", "条目"],
  "다운로드": ["download", "ダウンロード", "下载"],
  "압축 용량": ["compressed size", "圧縮サイズ", "压缩大小"],
  "디스크 사용량": ["disk usage", "ディスク使用量", "磁盘占用"],
  ...
  "번역문이 Discord 길이 제한을 초과했습니다. 내용을 줄이거나 직접 파일로 첨부하십시오.": ["The translation exceeds Discord's length limit. Shorten it or attach it as a file yourself.", "翻訳文がDiscordの文字数制限を超えています。短くするか、手動でファイルを添付してください。", "译文超过 Discord 的长度限制。请缩短内容或自行附加文件。"],
  ...
  "웹에서 사용할 번역 언어를 선택합니다.": ["Select the translation language used on the web.", "ウェブで使用する翻訳言語を選択します。", "选择网页翻译使用的语言。"],
  "웹 처리 방식": ["Web processing mode", "ウェブ処理方式", "网页处理方式"],
  "스크롤이 멈춘 뒤 문단을 묶어 번역합니다. Discord 메시지 번역에는 영향을 주지 않습니다.": ["Paragraphs are batched after scrolling stops. This does not affect Discord message translation.", "スクロールが止まってから段落をまとめて翻訳します。Discordメッセージの翻訳には影響しません。", "滚动停止后会批量翻译段落，不会影响 Discord 消息翻译。"],
  "페이지별 외부 전송 한도": ["External transfer limit per page", "ページごとの外部送信上限", "每页外部传输上限"],
  "외부 번역 서비스를 사용할 때 한 페이지에서 전송할 수 있는 문자 수를 제한합니다.": ["Limit the number of characters sent from one page when using an external translation service.", "外部翻訳サービスを使用するとき、1ページから送信できる文字数を制限します。", "使用外部翻译服务时，限制单个页面可传输的字符数。"],
  "웹 번역 전환키": ["Web translation toggle shortcut", "ウェブ翻訳切り替えキー", "网页翻译切换快捷键"],
  "웹페이지나 확장 팝업에 포커스가 있을 때 번역과 원문을 전환합니다.": ["Switch between translation and original text while a webpage or the extension popup has focus.", "ウェブページまたは拡張機能のポップアップにフォーカスがあるとき、翻訳と原文を切り替えます。", "网页或扩展程序弹出窗口获得焦点时，在译文和原文之间切换。"],
  "웹 번역 전환키를 사용하지 않습니다.": ["The web translation toggle shortcut is disabled.", "ウェブ翻訳切り替えキーは使用しません。", "网页翻译切换快捷键已停用。"],
  "웹 번역 전환키를 적용하지 못했습니다": ["Could not apply the web translation toggle shortcut", "ウェブ翻訳切り替えキーを適用できませんでした", "无法应用网页翻译切换快捷键"],
  "브라우저 연결": ["Browser connections", "ブラウザー接続", "浏览器连接"],
  "확장 프로그램이 연결되면 브라우저와 버전을 여기에 표시합니다.": ["Connected browsers and extension versions appear here.", "拡張機能が接続されると、ブラウザーとバージョンがここに表示されます。", "扩展程序连接后，将在此处显示浏览器和版本。"],
  "연결된 브라우저를 기다리고 있습니다.": ["Waiting for a browser connection.", "ブラウザーの接続を待っています。", "正在等待浏览器连接。"],
  ...
  "50,000자": ["50,000 characters", "50,000文字", "50,000 个字符"],
  ...
  "닉네임 번역하기": ["Translate nicknames", "ニックネームを翻訳する", "翻译昵称"],
  ...
  "번역할 원문 언어": ["Source languages to translate", "翻訳する原文の言語", "要翻译的原文语言"],
  "모든 언어를 번역하거나 선택한 언어만 번역합니다.": ["Translate all languages or only the languages you select.", "すべての言語、または選択した言語のみを翻訳します。", "翻译所有语言，或仅翻译所选语言。"],
  "모든 언어": ["All languages", "すべての言語", "所有语言"],
  "선택한 언어 없음": ["No languages selected", "言語が選択されていません", "未选择语言"],
  "원문 언어 설정을 적용하지 못했습니다": ["Could not apply the source language setting", "原文の言語設定を適用できませんでした", "无法应用原文语言设置"],
  ...
  "많은 메시지와 이미지를 계속 처리하므로 빠른 로컬 모델 사용을 권장합니다.": ["A fast local model is recommended because received messages and images are processed continuously.", "多くのメッセージや画像を継続的に処理するため、高速なローカルモデルを推奨します。", "由于需要持续处理大量消息和图片，建议使用快速的本地模型。"],
  ...
  "의미와 말투를 자연스럽게 전달하도록 품질 우선 CLI 모델 사용을 권장합니다.": ["A quality-first CLI model is recommended to convey meaning and tone naturally.", "意味と文体を自然に伝えるため、品質優先のCLIモデルを推奨します。", "建议使用质量优先的 CLI 模型，以自然地传达含义和语气。"],
  ...
  "권장 품질을 사용하려면 CLI 모델 연결이 필요합니다.": ["Connect a CLI model to use the recommended translation quality.", "推奨品質を使用するにはCLIモデルの接続が必要です。", "要使用推荐的翻译质量，需要连接 CLI 模型。"],
  "CLI 모델은 로컬 모델보다 문맥과 말투를 안정적으로 보존합니다. 번역할 메시지 텍스트만 선택한 서비스로 전송됩니다.": ["CLI models preserve context and tone more reliably than local models. Only the message text to translate is sent to the selected service.", "CLIモデルはローカルモデルよりも文脈と文体を安定して保持します。翻訳するメッセージ本文だけが選択したサービスへ送信されます。", "CLI 模型比本地模型更能稳定保留语境和语气。只有待翻译的消息文本会发送到所选服务。"],
  ...
  "품질 우선 모델로 보내는 메시지를 통역합니다.": ["Outgoing messages are translated with a quality-first model.", "品質優先モデルで送信メッセージを通訳します。", "使用质量优先模型翻译发送的消息。"],
  "로컬 모델보다 문맥과 말투를 안정적으로 보존합니다. 번역할 메시지 텍스트만 선택한 서비스로 전송됩니다.": ["It preserves context and tone more reliably than local models. Only the message text to translate is sent to the selected service.", "ローカルモデルよりも文脈と文体を安定して保持します。翻訳するメッセージ本文だけが選択したサービスへ送信されます。", "与本地模型相比，它能更稳定地保留语境和语气。只有待翻译的消息文本会发送到所选服务。"],
  "선택한 품질 우선 모델의 계정 연결이 필요합니다.": ["The selected quality-first model requires an account connection.", "選択した品質優先モデルにはアカウント接続が必要です。", "所选的质量优先模型需要连接账户。"],
  "계정 연결을 완료하면 문맥과 말투를 살린 권장 품질로 통역합니다. 번역할 메시지 텍스트만 전송됩니다.": ["After connecting your account, messages are translated at the recommended quality while preserving context and tone. Only the message text to translate is sent.", "アカウント接続が完了すると、文脈と文体を生かした推奨品質で通訳します。翻訳するメッセージ本文だけが送信されます。", "完成账户连接后，将以推荐质量翻译并保留语境和语气。只有待翻译的消息文本会被发送。"],
  "서비스 연결": ["Connect service", "サービスを接続", "连接服务"],
  ...
  "자동 보호는 GPU를 사용하다 VRAM이 부족해지면 현재 번역을 마친 뒤 CPU/RAM으로 전환합니다.": ["Automatic protection uses the GPU and switches to CPU/RAM after the current translation if VRAM runs low.", "自動保護ではGPUを使用し、VRAMが不足すると現在の翻訳完了後にCPU/RAMへ切り替えます。", "自动保护会使用 GPU，并在 VRAM 不足时于当前翻译完成后切换到 CPU/RAM。"],
  ...
  "위에서 선택한 서비스 하나만 연결하면 됩니다. 다른 서비스는 필요할 때 연결할 수 있습니다.": ["Connect only the service selected above. Other services can be connected later when needed.", "上で選択したサービスを一つだけ接続すれば使用できます。ほかのサービスは必要なときに接続できます。", "只需连接上方选择的一项服务。其他服务可在需要时再连接。"],
  "현재 사용": ["In use", "使用中", "当前使用"],
  "선택됨": ["Selected", "選択済み", "已选择"],
  "연결": ["Connect", "接続", "连接"],
  ...
  "인증 호환 모드": ["Verification compatibility mode", "認証互換モード", "验证兼容模式"],
  "Discord 인증을 완료한 후 NudeNyang을 다시 연결할 수 있습니다.": ["You can reconnect NudeNyang after completing Discord verification.", "Discordの認証が完了したら、NudeNyangを再接続できます。", "完成 Discord 验证后，可以重新连接 NudeNyang。"],
  "NudeNyang 다시 연결": ["Reconnect NudeNyang", "NudeNyangを再接続", "重新连接 NudeNyang"],
  "일반 Discord로 전환 중": ["Switching to standard Discord", "通常のDiscordに切り替えています", "正在切换到普通 Discord"],
  "일반 Discord 전환 실패": ["Could not switch to standard Discord", "通常のDiscordへの切り替えに失敗しました", "无法切换到普通 Discord"],
  "Discord 추가 인증이 필요합니다": ["Additional Discord verification is required", "Discordの追加認証が必要です", "需要进行额外的 Discord 验证"],
  "Discord에서 본인 확인이 요청되었습니다. 인증 과정에서 입력 충돌을 방지하기 위해 NudeNyang의 번역 연결을 일시 중지했습니다. 일반 Discord로 다시 시작하여 인증을 완료하는 것을 권장합니다.\n\nDiscord를 다시 시작하면 진행 중인 통화와 작성 중인 메시지가 종료될 수 있습니다.": ["Discord requested identity verification. NudeNyang paused its translation connection to prevent input conflicts during verification. We recommend restarting in standard Discord to complete it.\n\nRestarting Discord may end active calls and discard messages in progress.", "Discordから本人確認を求められました。認証中の入力競合を防ぐため、NudeNyangの翻訳接続を一時停止しました。通常のDiscordで再起動して認証を完了することを推奨します。\n\nDiscordを再起動すると、進行中の通話や作成中のメッセージが終了する場合があります。", "Discord 要求进行身份验证。为防止验证过程中出现输入冲突，NudeNyang 已暂停翻译连接。建议以普通 Discord 重新启动并完成验证。\n\n重新启动 Discord 可能会结束正在进行的通话并丢弃尚未发送的消息。"],
  "일반 Discord로 다시 시작": ["Restart in standard Discord", "通常のDiscordで再起動", "以普通 Discord 重新启动"],
  "현재 Discord에서 인증 계속": ["Continue verification in the current Discord", "現在のDiscordで認証を続ける", "在当前 Discord 中继续验证"],
  "NudeNyang을 다시 연결하시겠습니까?": ["Reconnect NudeNyang?", "NudeNyangを再接続しますか？", "要重新连接 NudeNyang 吗？"],
  "NudeNyang을 다시 연결하려면 Discord를 한 번 다시 시작해야 합니다. 진행 중인 통화와 작성 중인 메시지가 종료될 수 있습니다.": ["Discord must restart once to reconnect NudeNyang. Active calls and messages in progress may end.", "NudeNyangを再接続するには、Discordを一度再起動する必要があります。進行中の通話や作成中のメッセージが終了する場合があります。", "要重新连接 NudeNyang，需要重新启动一次 Discord。正在进行的通话和尚未发送的消息可能会结束。"],
  "Discord를 다시 시작하고 연결": ["Restart Discord and reconnect", "Discordを再起動して接続", "重新启动 Discord 并连接"],
  "NudeNyang 재연결 실패": ["Could not reconnect NudeNyang", "NudeNyangの再接続に失敗しました", "无法重新连接 NudeNyang"],
  "Discord 인증 보호 모드를 열지 못했습니다": ["Could not open Discord verification protection mode", "Discord認証保護モードを開けませんでした", "无法打开 Discord 验证保护模式"],
  ...
  "자동 보호 (권장)": ["Automatic protection (recommended)", "自動保護（推奨）", "自动保护（推荐）"],
  "GPU 우선": ["GPU first", "GPU優先", "GPU 优先"],
  ...
  "다른 프로그램을 위해 VRAM을 확보하고 CPU/RAM으로 전환했습니다.": ["Released VRAM for other programs and switched to CPU/RAM.", "ほかのプログラム用にVRAMを解放し、CPU/RAMへ切り替えました。", "已为其他程序释放 VRAM，并切换到 CPU/RAM。"],
  "VRAM 여유가 안정적으로 회복되어 GPU 사용을 다시 시작합니다.": ["VRAM has remained available, so GPU use is resuming.", "VRAMの空きが安定して回復したため、GPUの使用を再開します。", "VRAM 可用空间已稳定恢复，正在重新使用 GPU。"],
  ...
  "현재 번역을 마쳤습니다. 다른 프로그램을 위해 VRAM을 비우고 CPU/RAM 모드로 다시 준비하고 있습니다.": ["The current translation is complete. Releasing VRAM for other programs and preparing again in CPU/RAM mode.", "現在の翻訳が完了しました。ほかのプログラム用にVRAMを解放し、CPU/RAMモードで再準備しています。", "当前翻译已完成。正在为其他程序释放 VRAM，并以 CPU/RAM 模式重新准备。"],
  "VRAM 여유가 안정적으로 회복되어 GPU 모드로 다시 준비하고 있습니다.": ["VRAM availability has remained stable. Preparing again in GPU mode.", "VRAMの空きが安定して回復したため、GPUモードで再準備しています。", "VRAM 可用空间已稳定恢复，正在以 GPU 模式重新准备。"],
...
export const DYNAMIC_TEMPLATE_COPY = Object.freeze({
  "{count}개 선택": ["{count} selected", "{count}件選択", "已选择 {count} 项"],
  "{count}개 항목을 가져올 수 있습니다.": ["{count} entries can be imported.", "{count}件の項目をインポートできます。", "可导入 {count} 个条目。"],
  "{count}개 항목을 가져올 수 있습니다. {invalid}개 행은 원문이나 표시어가 없어 제외됩니다.": ["{count} entries can be imported. {invalid} rows are excluded because a source or display term is missing.", "{count}件の項目をインポートできます。原文または表示語がない{invalid}行は除外されます。", "可导入 {count} 个条目。另有 {invalid} 行缺少原文或显示词，已排除。"],
  "{inserted}개 추가 · {updated}개 수정 · {skipped}개 건너뜀": ["{inserted} added · {updated} updated · {skipped} skipped", "{inserted}件追加・{updated}件更新・{skipped}件スキップ", "新增 {inserted} 项 · 更新 {updated} 项 · 跳过 {skipped} 项"],
  ...
  "{model} VRAM 보호 전환 중": ["Switching {model} to VRAM protection mode"],
  "{model} GPU 모드 복귀 중": ["Returning {model} to GPU mode"],
...
export const DYNAMIC_COPY = Object.freeze([
  ...
  {
    pattern: /^(.+) VRAM 보호 전환 중$/,
    render: {
      en: model => `Switching ${model} to VRAM protection mode`,
      ja: model => `${model} をVRAM保護モードへ切り替え中`,
      zh: model => `正在将 ${model} 切换到 VRAM 保护模式`,
    },
  },
  {
    pattern: /^(.+) GPU 모드 복귀 중$/,
    render: {
      en: model => `Returning ${model} to GPU mode`,
      ja: model => `${model} をGPUモードへ戻しています`,
      zh: model => `正在将 ${model} 恢复为 GPU 模式`,
    },
  },
  {
...
const DYNAMIC_TEMPLATE_RESOLVERS = Object.freeze([
  ...
  ([model]) => ["{model} VRAM 보호 전환 중", { model }],
  ([model]) => ["{model} GPU 모드 복귀 중", { model }],
