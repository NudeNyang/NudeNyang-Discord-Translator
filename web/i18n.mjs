...
export const COPY = Object.freeze({
  ...
  "Discord 인증을 완료한 후 누드냥을 다시 연결할 수 있습니다.": ["You can reconnect NudeNyang after completing Discord verification.", "Discordの認証が完了したら、NudeNyangを再接続できます。", "完成 Discord 验证后，可以重新连接 NudeNyang。"],
  "누드냥 다시 연결": ["Reconnect NudeNyang", "NudeNyangを再接続", "重新连接 NudeNyang"],
  ...
  "누드냥을 다시 연결하시겠습니까?": ["Reconnect NudeNyang?", "NudeNyangを再接続しますか？", "要重新连接 NudeNyang 吗？"],
  "누드냥을 다시 연결하려면 Discord를 한 번 다시 시작해야 합니다. 진행 중인 통화와 작성 중인 메시지가 종료될 수 있습니다.": ["Discord must restart once to reconnect NudeNyang. Active calls and messages in progress may end.", "NudeNyangを再接続するには、Discordを一度再起動する必要があります。進行中の通話や作成中のメッセージが終了する場合があります。", "要重新连接 NudeNyang，需要重新启动一次 Discord。正在进行的通话和尚未发送的消息可能会结束。"],
  "Discord를 다시 시작하고 연결": ["Restart Discord and reconnect", "Discordを再起動して接続", "重新启动 Discord 并连接"],
  "누드냥 재연결 실패": ["Could not reconnect NudeNyang", "NudeNyangの再接続に失敗しました", "无法重新连接 NudeNyang"],
