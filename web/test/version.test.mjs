...
test("application version is consistently set to 0.5.20-beta", () => {
  const expected = "0.5.20-beta";
  ...
  assert.match(cargoToml, /version = "0\.5\.20-beta"/);
  assert.match(cargoLock, /name = "nude-translator-tauri"\s+version = "0\.5\.20-beta"/);
});
