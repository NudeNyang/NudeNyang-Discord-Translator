...
$DocFiles = @('FIREFOX_AMO_REVIEW.md', 'BROWSER_EXTENSION.md', 'BROWSER_STORE_PRIVACY.md', 'BROWSER_STORE_SUBMISSION_0.7.8.md', 'BROWSER_STORE_SUBMISSION_0.7.9.md', 'BROWSER_STORE_SUBMISSION_0.7.12.md', 'BROWSER_STORE_SUBMISSION_0.7.13.md', 'BROWSER_SHORTCUT_RECOVERY.md', 'WEB_READING_SCOPE.md', 'WEB_TRANSLATION_GLOBAL_SWITCH.md', 'WEB_TRANSLATION_PERFORMANCE.md', 'MESSENGER_SHARED_POLICY.md')
