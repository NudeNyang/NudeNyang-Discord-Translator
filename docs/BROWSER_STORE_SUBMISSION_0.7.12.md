# NudeNyang Web Translator 0.7.12 제출 자료

이 문서는 Chrome·Naver Whale·Firefox용 0.7.12 제출 파일과 스토어 입력 문구를 한곳에
...
최종 산출물은 `release/browser-extension/0.7.12-submission`에 둔다. 스토어 업로드와 심사
완료는 이 로컬 패키징과 별개다.

## 패키지

- Chrome·Whale 공용: `NudeNyang-Web-Translator-Chromium-0.7.12.zip`
- Firefox: `NudeNyang-Web-Translator-Firefox-0.7.12.xpi`
- Firefox 검토 소스: `NudeNyang-Web-Translator-Firefox-0.7.12-source.zip`
- 체크섬: `NudeNyang-Web-Translator-Firefox-0.7.12-SHA256SUMS.txt`, `SHA256SUMS.txt`
...
- 확장 단위 테스트 469개 통과.
- `npm run test:e2e`: 실제 Chromium MV3·합성 문서·모사 Native Messaging 155개 통과.
