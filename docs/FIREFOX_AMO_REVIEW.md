...
Output: `release/browser-extension/0.7.13-submission/NudeNyang-Web-Translator-Firefox-0.7.13.xpi`.
...
translation quality. See `WEB_READING_SCOPE.md` and `BROWSER_STORE_SUBMISSION_0.7.13.md`.
